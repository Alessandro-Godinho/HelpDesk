<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Cidade.aspx.cs" Inherits="WebApp.Admin.Cidade" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 Novo Item</asp:LinkButton>
            ...
            <Columns>
                <dx:GridViewDataTextColumn Caption="Cidade" FieldName="Nome" 
                    VisibleIndex="0">
                ...
                <dx:GridViewDataTextColumn Caption="UF" FieldName="UF" VisibleIndex="1">
                </dx:GridViewDataTextColumn>
            </Columns>
